                    ...
                    <ul className="top_nav_menu">
                        ...
                        <li className="account">
                            ...
                            <ul className="account_selection">
                                <li><a href="signin"><i className="fa fa-sign-in" aria-hidden="true"></i>Sign In</a></li>
                                <li><a href="signup"><i className="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
